...
import {View, Text, Button, CameraRoll, TouchableHighlight, Image, StyleSheet} from 'react-native';
...
const UploadSection = props => {
    useGallery = () => {
        ...
        CameraRoll.getPhotos ({ first: 100000, assetType: "Photos", groupTypes: "All" })
    ...
    return (
        <View>
                ...
                { (props.cameraActive && !props.gallerySelection) && 
                <Camera />
                }
...
const mapStateToProps = state => (
    {gallerySelection: state.UploadImageReducer.gallerySelection, cameraActive: state.UploadImageReducer.cameraActive}
)

const mapDispatchToProps = dispatch => (
    {
        retrieveGallery: (gallery) => dispatch (uploadImgActions.retrieveGallery (gallery)),
