...
import {ScrollView, View, CameraRoll, Dimensions, StyleSheet} from 'react-native';
        ...
        return (         
            <ScrollView styles={styles.root}>
                ...
                <View style={styles.grid}>
                    {this.props.gallery.map ((picture, id) => <ImgTile picture={picture} key={`galleryDisplayId${id}`} /> )}
                </View>
