const createFormData = (photo, operatingSystem, body) => {
    ...
    data.append('photo', 
    {
      name: 'Pic001',
      type: 'image',
      uri: operatingSystem === "android" ? photo.node.image.uri : photo.node.image.uri.replace("file://", "")
    });
      ...
      data.append (`photos`, 
        {
          name   : `Pic00${id}`,
          type   : 'image',
          uri    : operatingSystem === "android" ? el.node.image.uri : el.node.image.uri.replace("file://", "")
        })
